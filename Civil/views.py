...
from .forms import CivilForms
from homepage.models import Info
from django.core.mail import send_mail
import string

class CivilHome(TemplateView):
	template_name='Civil/civil_home.html'
...
class CivilForm(TemplateView):
	template_name='Civil/civil_form.html'

	def get(self,request):
		if request.session.get('user') is None:
			return HttpResponseRedirect('/civil/')
		form =  CivilForms()
		return render(request,self.template_name,{'form':form})
