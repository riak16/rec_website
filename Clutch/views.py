...
from .forms import ClutchForms
from homepage.models import Info
from django.core.mail import send_mail
import string

class ClutchHome(TemplateView):
	template_name='Clutch/clutch_home.html'
...
class ClutchForm(TemplateView):
	template_name='Clutch/clutch_form.html'

	def get(self,request):
		if request.session.get('user') is None:
			return HttpResponseRedirect('/clutch/')
		form =  ClutchForms()
		return render(request,self.template_name,{'form':form})
